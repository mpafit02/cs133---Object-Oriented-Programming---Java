 ...
 * 
 * It is the menu which interacts with the player. it tells you to choose
 * between some movements to develop your Empire.
 * 
 * Methods: start, play, manage, buildingOptions, unitOptions, recruitOptions,
 * explore
 * 
 * @author Marios
 *
...
public class UI {
	...
	public static void manage() {
		...
		while (!turnOver) {
			System.out.println(
					"Enter the number of the hex you would like to " + "select, or press [ENTER] to end your turn:\n");
			String input = scan.nextLine();
			if (input.length() < 2) {
				turnOver = true;
			}
			if (!turnOver) {
				GameController.selectTile(input.charAt(0) - 48, input.charAt(1) - 48);
	...
	public static void buildingOptions() {
		do {
			error = false;
			try {
				System.out.println("You selected " + GameController.selectedMapObjectString()
	...
	public static void unitOptions(boolean military) {
		...
		case 1:
			...
			System.out.println("Enter in the number of the adjacent tile" + " you'd like to move your unit to:\n");
			tile = scan.nextLine();
			if (GameController.moveSelected(tile.charAt(0) - 48, tile.charAt(1) - 48)) {
		...
		case 2:
			...
			if (military) {
				System.out.println("Enter in the number of the adjacent tile" + " containing your target:\n");
				tile = scan.nextLine();

				if (GameController.attackSelected(tile.charAt(0) - 48, tile.charAt(1) - 48)) {
